...
Let's reproduce the figure 11.9.4 chap11, p399: "response to foreseen 
once-and-for-all increase in tauc at time t=10
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
...
// it?s initial value of 0.2
    ...
    title('consumption tax : ${\tau}_c$','interpreter','latex','Fontsize',12)
    axis([0 N -.1 .5])
    set(gca,'Fontsize',12)

    print -depsc fig_cons_tax.eps
