...
Let's reproduce the figure 11.9.5 chap11, p399: "response to foreseen 
once-and-for-all increase in tauk at time t=10
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%*/
...
// it?s initial value of 0.2
    ...
    title('capital tax : ${\tau}_k$','interpreter','latex','Fontsize',12)
    axis([0 N -.1 .5])
    set(gca,'Fontsize',12)

    print -depsc fig_cap1.eps
